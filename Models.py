...
def model_logreg(x_train, X_Test, Y_train, y_test, flag=False):
    ...
    LogReg_Scores = (logreg_Se, logreg_Sp, logreg_PPV, logreg_NPV, logreg_Accuracy, logreg_F1, logreg_AUC)
    if flag:
...
def model_lin_svm(x_train, X_Test, Y_train, y_test, flag=False):
    ...
    lin_SVM_scores = (SVM_Se, SVM_Sp, SVM_PPV, SVM_NPV, SVM_Accuracy, SVM_F1, SVM_AUC)
    if flag:
...
def model_nonlin_svm(x_train, X_Test, Y_train, y_test, flag=False):
    ...
    nonlin_SVM_scores = (SVM_Se, SVM_Sp, SVM_PPV, SVM_NPV, SVM_Accuracy, SVM_F1, SVM_AUC)
    if flag:
...
def model_RFC(x_train, X_Test, Y_train, y_test, flag=False):
    ...
    RF_Scores = (RF_Se, RF_Sp, RF_PPV, RF_NPV, RF_Accuracy, RF_F1, RF_AUC)
    if flag:
